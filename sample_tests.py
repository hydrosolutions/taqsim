...
#debug_hydroworks_flow = debug_hydroworks_flow()
#print("Debug Hydroworks system test:")
#num_time_steps = 12
#debug_hydroworks_flow.simulate(num_time_steps)
#plot_water_system(debug_hydroworks_flow, "debug_hydroworks_time_series_plot.png")
#save_water_balance_to_csv(debug_hydroworks_flow, "debug_hydroworks_system_balance.csv")
#debug_hydroworks_flow.visualize("debug_hydroworks_system.png", display=False)
...
plot_water_balance_time_series(seasonal_system, "seasonal_reservoir_test_time_series.png", columns_to_plot)
